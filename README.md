...
- Replace all occurrences of "HTMLserver" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `HTMLserver` means the name of the project, while `html_server` is used in file names.
  - Remember to rename the `include/html_server` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
